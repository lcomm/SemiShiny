  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      sliderInput("alpha6.true",
                  ...
                  max = 2,
                  step = 0.1),
      sliderInput("lkappa1.true",
                  "Model 1 control reference log-hazard \\(log(\\kappa_1)\\) (bigger = faster):",
                  value = -2,
                  min = -8.5,
                  max = 0,
                  step = 0.25),
      sliderInput("lkappa2.true",
                  "Model 2 control reference log-hazard \\(log(\\kappa_2)\\) (bigger = faster):",
                  value = -6.5,
                  min = -8.5,
                  max = 0,
                  step = 0.25),
      sliderInput("lkappa3.true",
                  "Model 3 control reference log-hazard \\(log(\\kappa_3)\\) (bigger = faster):",
                  value = -5,
                  min = -8.5,
                  max = 0,
                  step = 0.25),
      sliderInput("lkappa4.true",
                  "Model 1 treated reference log-hazard \\(log(\\kappa_4)\\) (bigger = faster):",
                  value = -2.5,
                  min = -10,
                  max = 0,
                  step = 0.25),
      sliderInput("lkappa5.true",
                  "Model 2 treated reference log-hazard \\(log(\\kappa_5)\\) (bigger = faster):",
                  value = -7,
                  min = -10,
                  max = 0,
                  step = 0.25),
      sliderInput("lkappa6.true",
                  "Model 3 treated reference log-hazard \\(log(\\kappa_6)\\) (bigger = faster):",
                  value = -7,
                  min = -10,
                  max = 0,
                  step = 0.25),
...
server <- function(input, output) {
  ...
  dat <- reactive({
    simulate_RI(input$n, input$sigma.true, 
                ...
                exp(input$lkappa1.true), 
                exp(input$lkappa2.true), 
                exp(input$lkappa3.true),
                exp(input$lkappa4.true), 
                exp(input$lkappa5.true), 
                exp(input$lkappa6.true),
                cens)
  })
